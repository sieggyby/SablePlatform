...
cost_events = Table(
    ...
    Column("call_status", Text, nullable=False, server_default="'success'"),
    Column("created_at", Text, nullable=False, server_default=func.now()),
...
workflow_runs = Table(
    ...
    Column("workflow_version", Text, nullable=False, server_default="'1.0'"),
    Column("status", Text, nullable=False, server_default="'pending'"),
...
actions = Table(
    ...
    Column("action_type", Text, nullable=False, server_default="'general'"),
...
alert_configs = Table(
    ...
    Column("org_id", Text, ForeignKey("orgs.org_id"), nullable=False),
    Column("min_severity", Text, nullable=False, server_default="'warning'"),
...
prospect_scores = Table(
    ...
    Column("stage", Text),
    Column("dimensions_json", Text, nullable=False, server_default="'{}'"),
