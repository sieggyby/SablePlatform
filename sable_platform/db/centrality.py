...
def sync_centrality_scores(
    ...
    for score in scores:
        ...
        conn.execute(
            ...
            VALUES (:org_id, :entity_id, :degree, :in_cent, :out_cent, :run_date)
            ...
            {"org_id": org_id, "entity_id": entity_id, "degree": degree,
             "in_cent": in_cent, "out_cent": out_cent, "run_date": run_date},
        )
        upserted += 1
...
def list_centrality_scores(
    ...
    *,
    ...
    return conn.execute(
        ...
        WHERE org_id=:org_id AND degree_centrality >= :min_degree
        ORDER BY degree_centrality DESC
        LIMIT :limit
        """),
        {"org_id": org_id, "min_degree": min_degree, "limit": limit},
    ).fetchall()
