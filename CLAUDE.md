...
- **DB:** 60 migrations (032-041 SableKOL, 042 audit-review, 043-048 sable-roles discord layer + alert-triage, 049-053 Scored Mode V2, 054 state-pin, 055 media_assets, 056 operator reply-suggestions, 057 relay, 058 autocm, 059 work-tracking, 060 reply-clip-media), WAL mode, busy_timeout=5s, all CRUD helpers, online backup, GC, health check
